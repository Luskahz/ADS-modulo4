...
public class EditAccountGUI extends javax.swing.JDialog {
    ...
    public void refreshAccountInformation(AccountCurrent account) throws InvalidInputException {
        AccountCurrentDAO accountDao = new AccountCurrentDAO();
        AccountCurrent dbAccount = accountDao.getAccount(accountService.getId(account));
    ...
    private void TransactionConfirmBtn1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_TransactionConfirmBtn1ActionPerformed
        AccountCurrentDAO accountDao = new AccountCurrentDAO();
        AccountCurrent receiver_account = null;
        try {
